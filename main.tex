...
Throughout the source code of this \LaTeX\ document I will add tips and example code that may help or function as a template. Because of the latter goal, I have included section headers and other information here to save folks from extra typing when they go to make their own manuscript.
...
Another benefit of \LaTeX\ is that is way easier to write complicated math. This is not the place to go into how to do that, but if you are going to write mathy papers then \LaTeX\ is the way to go.
\section{Methods}
