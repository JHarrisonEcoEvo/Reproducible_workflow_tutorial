...
However, \LaTeX\ has a bit of a learning curve that can be frustrating at first. Persevere, get comfortable Googling stuff that you can't figure out, and soon you would rather write a paper with one hand then go back to using Word. 
