...
TIP: Use \$\textbackslash Sexpr\{X = 2:10;length(X)\}\$ to add R code output straight inline. One has to change the .tex ending to .Rtex for this to work right (at least with Overleaf). See more here at this knitr tutorial: \url{https://www.overleaf.com/learn/latex/Knitr}
